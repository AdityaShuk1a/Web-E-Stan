  ...
  return (
    ...
    <nav className=" flex flex-col sm:flex-row justify-evenly items-center  shadow-lg rounded-b-2xl" style={{ padding: '2vh 2vw' }}>
      ...
      <div className="BtnsContainer flex flex-col sm:flex-row gap-0 sm:gap-16 w-full sm:w-auto items-center justify-evenly backdrop-blur-sm rounded-xl  " style={{ padding: '1vh 1vw' }}>
        <button className="ContactBtn flex border-2 justify-evenly items-center w-3/4 sm:w-auto text-[1.5vh] sm:text-[2vh] md:text-[2.5vh] font-semibold rounded-xl hover:scale-105 transition-all duration-200 shadow-md" style={{ padding: '1vh 2vw' }}>
          Contact Us
        </button>
        <button className="LogoutBtn flex border-2 justify-evenly items-center w-3/4 sm:w-auto text-[1.5vh] sm:text-[2vh] md:text-[2.5vh]  font-semibold rounded-xl hover:scale-105 transition-all duration-200 shadow-md" style={{ padding: '1vh 2vw' }}>
          Log Out
        </button>
      </div>
