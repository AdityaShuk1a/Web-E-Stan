...
const MCQ = () => {
  ...
  return (
    <>
    <div className="flex h-[100vh] bg-amber-500 " style={{
        padding : "4vh"
    }}>
      <div className="flex flex-col items-start p-8 w-1/4 bg-lavender-200 border-2 border-black rounded-xl" style={{
        padding : "4vh"
      }}>
      ...
      <div className="flex flex-col items-center p-8 w-3/4">
        ...
        <div className="bg-gray-100 p-8 rounded-lg shadow-md w-[95%]" id={`question-${currentQuestion}`}>
          <div className="mb-4 text-3xl" style={{padding : "4vh"}} >What is the capital of France?</div>
        ...
        <button className="mt-8 bg-blue-500 text-white py-4 px-8 rounded absolute bottom-4 right-4 text-3xl" onClick={() => alert('Result calculated!')}>
          Submit
        </button>
        <button className="mt-8 bg-gray-500 text-white py-4 px-8 rounded absolute bottom-4 left-4 text-3xl" onClick={goBack}>
          Go Back
        </button>
      </div>
    </div>
